...
def main_page():
    ...
    cursor = cnx.cursor()from flask import Flask, render_template, flash, redirect, Session
from app import app
from app.login_form import LoginForm
...
def main_page():
    ...
    EditPaper = EditPapers() # Added edit paper button -Nick
    ...
    return render_template('main.html', createForm=createDB, assignReviewForm=assignReviewers, editPaper=EditPaper)
